...
public class ResultScoreActor extends NumberGroup{

    public ResultScoreActor(){

        Array<TextureAtlas.AtlasRegion> regions = AssetManagerUtils.getInstance().getTextureAtlas().findRegions(ResConstant.Atlas.IMAGE_NUM_SCORE_00_TO_09);
